...
$$
Y_{it} = \beta_0 + \beta_1 X_{it} +\theta_i + u_{it}
$$
...
$$
Y_{it} = \beta_0 + \beta_1 X_{it} +\pi_t + u_{it}
$$
...
$$
Y_{it} =\beta_1 X_{it} +\theta_i + \pi_t + u_{it}
$$
...
$$
Y_{it} =\beta_1 X1_{it} + \beta_2 X2_{it} +\theta_i + \pi_t + u_{it}
$$
