---
title: "Rで学ぶ計量経済学と機械学習 11<br> <br> 機械学習2：リッジ回帰とラッソ回帰"
...
以下の図は，25個の学習用データでの誤差と，25個のテストデータでの誤差をモデルごとに示したものである。
...
# testに対する予測精度
y_test_pred <- predict(EN_cv, 
                      X_test, 
                      s = "lambda.min") # 予測
test_error <- RMSE(y_test_pred, 
                  y_test) # 誤差
str_c("test_error: ", round(test_error, 3)) %>% print() # 結果を表示
```
