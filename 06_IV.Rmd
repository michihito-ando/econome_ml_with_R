---
title: "Rで学ぶ計量経済学と機械学習 5<br> <br> 計量経済学２：操作変数法"
...
今回は、前回のデータに新たな変数を加える。**「能力に関係なく、30％の確率でランダムに選ばれた人が学費を免除され、入学を許可される」**という制度があるとし，さらに、**ここで学費免除で選ばれた人のうち、50%の人が大学を卒業する**とする。
